...
Debezium+Kafka em `local-services/streaming-cdc/`. A decisão aqui não é "qual
...
- `local-services/streaming-cdc/README.md:3-4` — o Debezium como alternativa.
- `local-services/streaming-cdc/README.md:37-45` — o tópico consumido por dois
  outros componentes: a evidência do fan-out que justifica o Kafka no streaming.
- `local-services/streaming-cdc/README.md:66-70` — o replication slot órfão.
